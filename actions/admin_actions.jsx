...
export function saveConfig(config, success, error) {
    AdminActions.updateConfig(config)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
...
export function reloadConfig(success, error) {
    AdminActions.reloadConfig()(dispatch, getState).then(data => {
        if (data && success) {
...
export function adminResetMfa(userId, success, error) {
    UserActions.updateUserMfa(userId, false)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function getClusterStatus(success, error) {
    AdminActions.getClusterStatus()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function testEmail(config, success, error) {
    AdminActions.testEmail(config)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function ldapTest(success, error) {
    AdminActions.testLdap()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function invalidateAllCaches(success, error) {
    AdminActions.invalidateCaches()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function recycleDatabaseConnection(success, error) {
    AdminActions.recycleDatabase()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function adminResetPassword(userId, password, success, error) {
    UserActions.updateUserPassword(userId, '', password)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
            const serverError = getState().requests.users.updateUser.error;
...
export function samlCertificateStatus(success, error) {
    AdminActions.getSamlCertificateStatus()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function getOAuthAppInfo(clientId, success, error) {
    Client4.getOAuthAppInfo(clientId)
        .then(data => {
            if (success) {
                success(data);
            }
...
export function allowOAuth2(params, success, error) {
    ...
    Client4.authorizeOAuthApp(responseType, clientId, redirectUri, state, scope)
        .then(data => {
            if (success) {
                success(data);
            }
...
export function emailToLdap(loginId, password, token, ldapId, ldapPassword, success, error) {
    UserActions.switchEmailToLdap(loginId, password, ldapId, ldapPassword, token)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function emailToOAuth(loginId, password, token, newType, success, error) {
    UserActions.switchEmailToOAuth(newType, loginId, password, token)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
            const serverError = getState().requests.users.switchLogin.error;
...
export function oauthToEmail(currentService, email, password, success, error) {
    UserActions.switchOAuthToEmail(currentService, email, password)(dispatch, getState).then(data => {
        if (data) {
            if (data.follow_link) {
...
export function uploadBrandImage(brandImage, success, error) {
    AdminActions.uploadBrandImage(brandImage)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function uploadLicenseFile(file, success, error) {
    AdminActions.uploadLicense(file)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function removeLicenseFile(success, error) {
    AdminActions.removeLicense()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function uploadPublicSamlCertificate(file, success, error) {
    AdminActions.uploadPublicSamlCertificate(file)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function uploadPrivateSamlCertificate(file, success, error) {
    AdminActions.uploadPrivateSamlCertificate(file)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function uploadIdpSamlCertificate(file, success, error) {
    AdminActions.uploadIdpSamlCertificate(file)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function removePublicSamlCertificate(success, error) {
    AdminActions.removePublicSamlCertificate()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function removePrivateSamlCertificate(success, error) {
    AdminActions.removePrivateSamlCertificate()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function removeIdpSamlCertificate(success, error) {
    AdminActions.removeIdpSamlCertificate()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function elasticsearchTest(config, success, error) {
    AdminActions.testElasticsearch(config)(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
...
export function elasticsearchPurgeIndexes(success, error) {
    AdminActions.purgeElasticsearchIndexes()(dispatch, getState).then(data => {
        if (data && success) {
            success(data);
        } else if (data == null && error) {
