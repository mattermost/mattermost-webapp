...
function preLogin(nextState, replace, callback) {
    ...
    if (window.mm_config.IosAppDownloadLink && UserAgent.isIosWeb() && !BrowserStore.hasSeenLandingPage()) {
        ...
        window.mm_config.AndroidAppDownloadLink &&
    ...
    getChildRoutes: RouteUtils.createGetChildComponentsFunction([
        {
            getComponents: (location, callback) => {
                System.import('components/header_footer_template.jsx').then(
            ...
            getChildRoutes: RouteUtils.createGetChildComponentsFunction([
                {
                    ...
                    onEnter: preLogin,
                    getComponents: (location, callback) => {
                        System.import('components/login/login_controller.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    path: 'reset_password',
                    getComponents: (location, callback) => {
                        System.import('components/password_reset_send_link.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    ...
                    getComponents: (location, callback) => {
                        System.import('components/password_reset_form.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                claimAccountRoute,
                {
                    ...
                    getComponents: (location, callback) => {
                        System.import('components/signup/signup_controller.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    path: 'signup_email',
                    getComponents: (location, callback) => {
                        System.import('components/signup/components/signup_email.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    path: 'signup_ldap',
                    getComponents: (location, callback) => {
                        System.import('components/signup/components/signup_ldap.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    ...
                    getComponents: (location, callback) => {
                        System.import('components/should_verify_email.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
                {
                    ...
                    getComponents: (location, callback) => {
                        System.import('components/do_verify_email.jsx').then(
                            RouteUtils.importComponentSuccess(callback)
                        );
                    }
                },
        ...
        },
        {
            path: 'get_ios_app',
            getComponents: (location, callback) => {
                System.import('components/get_ios_app/get_ios_app.jsx').then(
                    RouteUtils.importComponentSuccess(callback)
                );
            }
        },
        {
            ...
            getComponents: (location, callback) => {
                System.import('components/get_android_app/get_android_app.jsx').then(
                    RouteUtils.importComponentSuccess(callback)
                );
            }
        },
                    ...
                    getChildRoutes: RouteUtils.createGetChildComponentsFunction([
                        {
                            path: 'select_team',
                            getComponents: (location, callback) => {
                                System.import('components/select_team').then(
                                    RouteUtils.importComponentSuccess(callback)
                                );
                            }
                        },
                        {
                            path: '*authorize',
                            getComponents: (location, callback) => {
                                System.import('components/authorize.jsx').then(
                                    RouteUtils.importComponentSuccess(callback)
                                );
                            }
                        },
