...
export default function GetAndroidApp() {
    return (
        <div className="get-app get-android-app">
            ...
            <hr />
            <div>
                <img className="get-android-app__icon" src={MattermostIcon} />
                <div className="get-android-app__app-info">
                    <span className="get-android-app__app-name">
                        <FormattedMessage id="get_app.androidAppName" defaultMessage="Mattermost for Android" />
                    </span>
                    <span className="get-android-app__app-creator">
                        <FormattedMessage id="get_app.mattermostInc" defaultMessage="Mattermost, Inc" />
                    </span>
                </div>
            </div>
            <a
            ...
            >
                <FormattedMessage id="get_app.continue" defaultMessage="Continue" />
            </a>
            <img className="get-app__screenshot" src={Nexus6Mockup} />
