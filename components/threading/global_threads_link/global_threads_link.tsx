...
import {useThreadsLinkMeta} from '../hooks';
...
const GlobalThreadsLink = () => {
    ...
    const showTutorialTrigger = isCrtEnabled && crtTutorialTrigger === Constants.CrtTutorialTriggerSteps.START && !appHaveOpenModal && Boolean(threadsCount) && threadsCount.total >= 1;
