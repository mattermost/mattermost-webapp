                            ...
                            <div className='col-sm-4'>
                                <div className='section'>
                                    <div>
                                        ...
                                        <span>
                                            <strong>
                                                <ShortcutSequence shortcut={shortcuts.msgMarkdownHeader}/>
                                            </strong>
                                        </span>
                                        <div className='subsection'>
                                            <ShortcutSequence shortcut={shortcuts.msgMarkdownBold}/>
                                            <ShortcutSequence shortcut={shortcuts.msgMarkdownItalic}/>
                                            <ShortcutSequence shortcut={shortcuts.msgMarkdownLink}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
