        ...
        if (global.window.mm_config.EnablePublicLink === 'true') {
            publicLink = (
                <div>
                    ...
                    >
                        <FormattedMessage id="view_image_popover.publicLink" defaultMessage="Get Public Link" />
                    </a>
        ...
        if (FileUtils.canDownloadFiles()) {
            downloadLinks = (
                <div className="image-links">
                    ...
                    >
                        <FormattedMessage id="view_image_popover.download" defaultMessage="Download" />
                    </a>
                </div>
            );
        }
