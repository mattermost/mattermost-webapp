...
function mapStateToProps() {
    return (state, ownProps) => {
        ...
        return {
            ...
            currentUserId,
            codeBlockOnCtrlEnter: getBool(state, PreferencesRedux.CATEGORY_ADVANCED_SETTINGS, PreferencesRedux.ADVANCED_CODE_BLOCK_ON_CTRL_ENTER, true),
            ctrlSend: getBool(state, PreferencesRedux.CATEGORY_ADVANCED_SETTINGS, PreferencesRedux.ADVANCED_SEND_ON_CTRL_ENTER),
