...
const MarkdownImageExpand: React.FC<Props> = ({ children, alt, collapseDisplay }: Props) => {
    ...
    return (
        <div className={wrapperClassName}>
            <CSSTransition in={isExpanded} timeout={200} mountOnEnter unmountOnExit classNames="markdown-image-expand__expanded-view">
                <div>
                    <button
            ...
            <CSSTransition in={!isExpanded} timeout={200} mountOnEnter unmountOnExit classNames="markdown-image-expand__collapsed-view">
                <div>
                    <button
