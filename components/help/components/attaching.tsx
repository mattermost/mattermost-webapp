        ...
        <div>
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Upload a file or selection of files by dragging the files from your computer into the right-hand sidebar or center pane. Dragging and dropping attaches the files to the message input box, then you can optionally type a message and press **ENTER** to post it.'
                />
            </p>
            <h4 className='markdown__heading'>
                <FormattedMessage
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Alternatively, upload files by selecting the grey **Attachment** icon inside the message input box. In the system file viewer, navigate to the desired files, then select **Open** to upload them to the message input box. Optionally type a message and then press **ENTER** to post it.'
                />
            </p>
            <h4 className='markdown__heading'>
                <FormattedMessage
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='On Chrome and Edge browsers, you can also upload files by pasting them from the system clipboard. This is not yet supported on other browsers.'
                />
            </p>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Mattermost has a built in file previewer used to view media, download files, and share public links. Select the thumbnail of an attached file to open it in the file previewer.'
                />
            </p>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='If you are trying to preview a media type that is not supported, the file previewer opens a standard media attachment icon. Supported media formats depend heavily on your browser and operating system, but the following formats are supported by Mattermost on most browsers:'
                />
            </p>
            <ul>
                <li>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Other document previews (such as Word, Excel, or PPT) are not yet supported.'
                />
            </p>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Mattermost supports up to five files attached per post. The default maximum file size is 100 MB, but this can be changed by the System Admin. Image files can be a maximum size of 6048 pixels x 4032 pixels, or 24 MP (mega pixels), or a raw image file size of approximately 36 MB.'
                />
            </p>
            <p className='links'>
                <FormattedMessage
