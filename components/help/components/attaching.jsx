...
export default function HelpAttaching() {
    ...
    message.push(
        localizeMessage(
            'help.attaching.supportedList',
            '- Images: BMP, GIF, JPG, JPEG, PNG\n- Video: MP4\n- Audio: MP3, M4A\n- Documents: PDF'
        )
    );
    message.push(
        localizeMessage('help.attaching.notSupported', 'Document preview (Word, Excel, PPT) is not yet supported.')
    );
    message.push(
        localizeMessage(
            'help.attaching.limitations',
