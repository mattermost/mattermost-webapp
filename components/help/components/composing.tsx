        ...
        <div>
            ...
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Posts can be considered parent messages when they start a thread of replies. Posts are composed and sent from the text input box at the bottom of the center pane.'
                />
            </p>
            <h4 className='markdown__heading'>
                <FormattedMessage
            ...
            <p>
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Write a message by typing into the text input box, then press ENTER to send it. Use SHIFT+ENTER to create a new line without sending a message. To send messages by pressing CTRL+ENTER go to **Account Settings > Advanced > Send Messages on CTRL/CMD+ENTER**.'
                />
            </p>
            <h2 className='markdown__heading'>
                <FormattedMessage
