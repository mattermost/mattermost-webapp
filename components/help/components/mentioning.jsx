...
export default function HelpMentioning() {
    ...
    message.push(
        localizeMessage(
            'help.mentioning.mentions',
            '## @Mentions\nUse @mentions to get the attention of specific team members.'
        )
    );
    message.push(
        localizeMessage(
            'help.mentioning.username',
    ...
    message.push(
        '```\n' +
            localizeMessage(
                'help.mentioning.usernameExample',
    ...
    message.push(
        '```\n' +
            localizeMessage(
                'help.mentioning.channelExample',
