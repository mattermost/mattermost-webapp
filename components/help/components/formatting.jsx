...
export default function HelpFormatting() {
    ...
    message.push(
        localizeMessage(
            'help.formatting.supportedSyntax',
    ...
    message.push(
        localizeMessage(
            'help.formatting.links',
            '## Links\n\nCreate labeled links by putting the desired text in square brackets and the associated link in normal brackets.'
        )
    );
    message.push(
        '`' + localizeMessage('help.formatting.linkEx', '[Check out Mattermost!](https://about.mattermost.com/)') + '`'
    );
    message.push(
        localizeMessage('help.formatting.renders', 'Renders as:') +
            ' ' +
            localizeMessage('help.formatting.linkEx', '[Check out Mattermost!](https://about.mattermost.com/)')
    );
    message.push(
        localizeMessage(
            'help.formatting.images',
    ...
    message.push(
        localizeMessage('help.formatting.lines', '## Lines\n\nCreate a line by using three `*`, `_`, or `-`.')
    );
    message.push('`***` ' + localizeMessage('help.formatting.renders', 'Renders as:') + '\n***');
    ...
    message.push(
        '```\n' +
            localizeMessage(
                'help.formatting.checklistExample',
                '- [ ] Item one\n- [ ] Item two\n- [x] Completed item'
            ) +
            '\n```'
    );
    ...
    message.push(
        '```\n' +
            localizeMessage(
                'help.formatting.headingsExample',
    ...
    return (
        <div>
            <span dangerouslySetInnerHTML={{__html: formatText(message.join('\n\n'))}} />
            <p className="links">
