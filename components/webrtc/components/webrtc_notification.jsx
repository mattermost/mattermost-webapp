...
export default class WebrtcNotification extends React.Component {
    ...
    onCancelCall(message) {
        if (message && message.action !== WebrtcActionTypes.CANCEL) {
            ...
            message &&
            message.action === WebrtcActionTypes.CANCEL &&
            this.state.userCalling &&
            message.from_user_id !== this.state.userCalling.id
        ) {
            return;
        }
        ...
        if (user) {
            ...
            const answerBtn = (
                ...
                >
                    <circle cx="24" cy="24" r="34">
                        <title>
                            <FormattedMessage id="webrtc.notification.answer" defaultMessage="Answer" />
                        </title>
                    </circle>
                    <path
            ...
            const rejectBtn = (
                ...
                >
                    <circle cx="24" cy="24" r="34">
                        <title>
                            <FormattedMessage id="webrtc.notification.decline" defaultMessage="Decline" />
                        </title>
                    </circle>
                    <path
            ...
            const msg = (
                <div>
                    ...
                    />
                    <div className="webrtc-buttons webrtc-icons active" style={{marginTop: '5px'}}>
                        {answerBtn}
                        {rejectBtn}
                    </div>
                </div>
            ...
            return (
                <div className="webrtc-notification">
                    <audio ref="ring" src={ring} autoPlay={true} />
                    <div>{profileImg}</div>
                    {msg}
                </div>
            );
            ...
            return (
                <div className="webrtc__notification--rhs" onClick={this.closeRightHandSide}>
