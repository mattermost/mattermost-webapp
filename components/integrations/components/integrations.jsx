        ...
        if (config.EnableIncomingWebhooks === 'true') {
            options.push(
                <IntegrationOption
                    ...
                    title={
                        <FormattedMessage id="integrations.incomingWebhook.title" defaultMessage="Incoming Webhook" />
                    }
                    description={
                        <FormattedMessage
        ...
        if (config.EnableOutgoingWebhooks === 'true') {
            options.push(
                <IntegrationOption
                    ...
                    title={
                        <FormattedMessage id="integrations.outgoingWebhook.title" defaultMessage="Outgoing Webhook" />
                    }
                    description={
                        <FormattedMessage
        ...
        if (config.EnableCommands === 'true') {
            options.push(
                <IntegrationOption
                    ...
                    title={<FormattedMessage id="integrations.command.title" defaultMessage="Slash Command" />}
                    description={
                        <FormattedMessage
        ...
        if (
            ...
            options.push(
                <IntegrationOption
                    ...
                    image={OAuthIcon}
                    title={
                        <FormattedMessage id="integrations.oauthApps.title" defaultMessage="OAuth 2.0 Applications" />
                    }
                    description={
                        <FormattedMessage
