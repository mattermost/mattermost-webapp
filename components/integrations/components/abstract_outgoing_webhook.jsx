                    ...
                    <form className="form-horizontal" onSubmit={this.handleSubmit}>
                        <div className="form-group">
                            <label className="control-label col-sm-4" htmlFor="displayName">
                                <FormattedMessage id="add_outgoing_webhook.displayName" defaultMessage="Display Name" />
                            </label>
                        ...
                        <div className="backstage-form__footer">
                            ...
                            <Link className="btn btn-sm" to={`/${this.props.team.name}/integrations/outgoing_webhooks`}>
