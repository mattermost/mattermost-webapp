...
export default class ResetPasswordModal extends React.Component {
    ...
    render() {
        ...
        if (this.state.serverError) {
            ...
            serverError = (
                <div className="has-error">
                    <p className="input__help error">{this.state.serverError}</p>
                </div>
            );
        }
        ...
        return (
            <Modal show={this.props.show} onHide={this.doCancel}>
                ...
                <form role="form" className="form-horizontal">
                        ...
                        <div className="form-group">
                            <div className="col-sm-10">
                                <div className={urlClass}>
                                    <span data-toggle="tooltip" title="New Password" className="input-group-addon">
                                        <FormattedMessage
                    ...
                    <Modal.Footer>
                        <button type="button" className="btn btn-default" onClick={this.doCancel}>
                            <FormattedMessage id="admin.reset_password.close" defaultMessage="Close" />
                        </button>
                        <button onClick={this.doSubmit} type="submit" className="btn btn-primary" tabIndex="2">
                            <FormattedMessage id="admin.reset_password.select" defaultMessage="Select" />
                        </button>
                    </Modal.Footer>
                </form>
            </Modal>
