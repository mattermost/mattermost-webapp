...
export default class LegalAndSupportSettings extends AdminSettings {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.customization.support" defaultMessage="Legal and Support" />;
    }
        ...
        return (
            <SettingsGroup>
                <TextSetting
                    ...
                    label={<FormattedMessage id="admin.support.termsTitle" defaultMessage="Terms of Service link:" />}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    label={<FormattedMessage id="admin.support.privacyTitle" defaultMessage="Privacy Policy link:" />}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="aboutLink"
                    label={<FormattedMessage id="admin.support.aboutTitle" defaultMessage="About link:" />}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="helpLink"
                    label={<FormattedMessage id="admin.support.helpTitle" defaultMessage="Help link:" />}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    ...
                    label={<FormattedMessage id="admin.support.problemTitle" defaultMessage="Report a Problem link:" />}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="supportEmail"
                    label={<FormattedMessage id="admin.support.emailTitle" defaultMessage="Support Email:" />}
                    helpText={
                        <FormattedMessage
