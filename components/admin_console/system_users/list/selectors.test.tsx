    ...
    describe('should search by term', () => {
        ...
        describe('over all profiles', () => {
            ...
            it('returning users users', () => {
                ...
                (users.searchProfilesStartingWithTerm as jest.Mock).mockReturnValue(expectedUsers);

                expect(getUsers(state, loading, teamId, term, filter)).toEqual(expectedUsers);
                expect(users.searchProfilesStartingWithTerm).toBeCalledWith(state, term, false, {});
            });
            ...
            describe('falling back to fetching user by id', () => {
                ...
                it('and the user is found', () => {
                    ...
                    (users.searchProfilesStartingWithTerm as jest.Mock).mockReturnValue([]);
