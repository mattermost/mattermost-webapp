        ...
        integration_management: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_NUMBER,
                        key: "ServiceSettings.InteractiveDialogTriggerTimeout",
                        label: t("admin.service.InteractiveDialogTriggerTimeout.title"),
                        label_default: "Interactive Dialog Trigger Timeout:",
                        help_text: t("admin.service.InteractiveDialogTriggerTimeout.desc"),
