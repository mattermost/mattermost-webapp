        ...
        posts: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
                        key: 'ServiceSettings.EnableOfficeFilePreviews',
                        label: t('admin.customization.enableOfficeFilePreviewsTitle'),
                        label_default: 'Enable Office Files Preview:',
                        help_text: t('admin.customization.enableOfficeFilePreviewsDesc'),
                        help_text_default: 'Enable Office File previews (doc, docx, ppt, pptx, rtf, odt, odp).',
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        key: 'ServiceSettings.MMPreviewURL',
                        label: t('admin.service.mmpreviewURLTitle'),
                        label_default: 'MMPreview Server URL:',
                        placeholder: t('admin.service.mmpreviewURLExample'),
                        placeholder_default: 'E.g.: "http://localhost:4000"',
                        help_text: t('admin.service.mmpreviewURLDescription'),
                        help_text_default: 'MMPreview server allow us to preview office documents. To install and setup your own mmpreview url server, you can go here https://github.com/mattermost/mmpreview and follow the instructions.',
                        isDisabled: it.stateIsFalse('ServiceSettings.EnableOfficeFilePreviews'),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        key: 'ServiceSettings.MMPreviewSecret',
                        label: t('admin.service.mmpreviewSecretTitle'),
                        label_default: 'MMPreview Secret:',
                        placeholder: t('admin.service.mmpreviewURLExample'),
                        placeholder_default: 'E.g.: "my-secret-string"',
                        help_text: t('admin.service.mmpreviewURLDescription'),
                        help_text_default: 'MMPreview secret is a pre-shared secret with the mmpreview server to only authorize servers that knows the secret to use the preview service.',
                        isDisabled: it.stateIsFalse('ServiceSettings.EnableOfficeFilePreviews'),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_CUSTOM,
