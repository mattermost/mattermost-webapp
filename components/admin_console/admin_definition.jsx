            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        label: t('admin.console.files.maxVoiceMessageFileSizeTitle'),
                        label_default: 'Voice message max size:',
                        help_text: t('admin.console.files.maxVoiceMessageFileSizeDesc'),
                        help_text_default: 'Maximum file size for voice messages in megabytes. Note: this number must be lower or equal to your server maximum file size.',
                        onConfigLoad: (configVal) => configVal / MEBIBYTE,
                        onConfigSave: (displayVal) => displayVal * MEBIBYTE,
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        label_default: 'Voice Messages:',
                        help_text: t('admin.experimental.enableVoiceMessages.helpText'),
                        help_text_default: 'Enable sending voice messages in chat.',
                        help_text_markdown: true,
                        isHidden: it.configIsFalse('FeatureFlags', 'VoiceMessages'),
                        isDisabled: it.any(
                            it.configIsFalse('FileSettings', 'EnableFileAttachments'),
