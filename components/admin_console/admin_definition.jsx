            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        label_default: 'Enable Client Debugging: ',
                        help_text: t('admin.service.performanceDebuggingDescription'),
                        help_text_default: 'When true, users can access debugging settings for their account in **Settings > Advanced > Debugging** to assist in diagnosing issues.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.DEVELOPER)),
                    },
                    {
