        ...
        users_and_teams: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
                        key: 'TeamSettings.EnableReadReceipts',
                        label: t('admin.team.readReceiptsTitle'),
                        label_default: 'Enable Read Receipts: ',
                        help_text: t('admin.team.readReceiptsDescription'),
                        help_text_default: 'When enabled, users will see read receipts for messages sent in Direct and Group Messages. Users can optionally disable read receipts in Account Settings. Learn more in our documentation.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.USERS_AND_TEAMS)),
                    },
                ],
            },
