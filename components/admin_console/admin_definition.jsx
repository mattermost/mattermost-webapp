        ...
        experimental_features: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_NUMBER,
                        key: 'ExperimentalSettings.WebsocketJitterRange',
                        label: t('admin.experimental.WebsocketJitterRange.title'),
                        label_default: 'Maximum websocket jitter range:',
                        help_text: t('admin.experimental.WebsocketJitterRange.desc'),
                        help_text_default: 'This setting defines the maximum range of jitter to add to the websocket incoming connections. This is used to prevent thundering heard problem on the server. The value is in milliseconds. Setting it to "0" means no jitter is added.',
                        isHidden: it.licensedForFeature('Cloud'),
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.EXPERIMENTAL.FEATURES)),
                    },
                ],
