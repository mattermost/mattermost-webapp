...
export default {
    ...
    environment: {
        ...
        email_notifications: {
            url: 'environment/email_notifications',
            title: t('admin.sidebar.emailNotifications'),
            title_default: 'Email Notifications',
            isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
            schema: {
                id: 'EmailNotificationsSettings',
                name: t('admin.environment.emailNotifications'),
                name_default: 'Email Notifications',
                settings: [
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
                        key: 'EmailSettings.SendEmailNotifications',
                        label: t('admin.environment.emailNotifications.enable.title'),
                        label_default: 'Enable Email Notifications:',
                        help_text: t('admin.environment.emailNotifications.enable.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.enablePreviewModeBanner.title'),
                        label_default: 'Enable Preview Mode Banner:',
                        help_text: t('admin.environment.emailNotifications.enablePreviewModeBanner.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.enableEmailBatching.title'),
                        label_default: 'Enable Email Batching:',
                        help_text: t('admin.environment.emailNotifications.enableEmailBatching.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.contents.title'),
                        label_default: 'Email Notification Contents:',
                        help_text: t('admin.environment.emailNotifications.contents.description'),
                        ...
                        options: [
                            {
                                value: 'full',
                                display_name: t('admin.environment.emailNotifications.contents.full'),
                                display_name_default: 'Send full message contents',
                            },
                            {
                                value: 'generic',
                                display_name: t('admin.email.notification.contents.generic'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.notificationDisplay.title'),
                        label_default: 'Notification Display Name:',
                        placeholder: t('admin.environment.emailNotifications.notificationDisplay.placeholder'),
                        placeholder_default: 'Ex: "Mattermost Notification", "System", "No-Reply"',
                        help_text: t('admin.environment.emailNotifications.notificationDisplay.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.feedbackEmail.title'),
                        label_default: 'Notification From Address:',
                        placeholder: t('admin.environment.emailNotifications.feedbackEmail.placeholder'),
                        placeholder_default: 'Ex: "mattermost@yourcompany.com", "admin@yourcompany.com"',
                        help_text: t('admin.environment.emailNotifications.feedbackEmail.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.replyToAddress.title'),
                        label_default: 'Notification Reply-To Address:',
                        placeholder: t('admin.environment.emailNotifications.replyToAddress.placeholder'),
                        placeholder_default: 'Ex: "mattermost@yourcompany.com", "admin@yourcompany.com"',
                        help_text: t('admin.environment.emailNotifications.replyToAddress.description'),
                    ...
                    },
                    {
                        ...
                        label: t('admin.environment.emailNotifications.feedbackOrganization.title'),
                        label_default: 'Notification Footer Mailing Address:',
                        placeholder: t('admin.environment.emailNotifications.feedbackOrganization.placeholder'),
                        placeholder_default: 'Ex: "© ABC Corporation, 565 Knight Way, Palo Alto, California, 94305, USA"',
                        help_text: t('admin.environment.emailNotifications.feedbackOrganization.description'),
        ...
        push_notifications: {
            url: 'environment/push_notifications',
