        ...
        experimental_features: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_NUMBER,
                        key: 'ExperimentalSettings.InteractiveDialogTriggerTimeoutInMilliseconds',
                        label: t('admin.experimental.InteractiveDialogTriggerTimeoutInMilliseconds.title'),
                        label_default: 'Interactive Dialog Trigger Timeout:',
                        help_text: t('admin.experimental.InteractiveDialogTriggerTimeoutInMilliseconds.desc'),
                        help_text_default: 'The number of milliseconds to wait for a response from the server when triggering an interactive dialog. If the server does not respond within the timeout, the dialog will not be displayed.',
                        help_text_markdown: false,
                        placeholder: t('admin.experimental.InteractiveDialogTriggerTimeoutInMilliseconds.example'),
                        placeholder_default: 'E.g.: "5000"',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.EXPERIMENTAL.FEATURES)),
                    },
                ],
