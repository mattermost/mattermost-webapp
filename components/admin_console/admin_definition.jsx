...
// and pages. Each page contains an schema which defines the name of the
// section (name and name_default), the section in the config file (id), and a list of options
