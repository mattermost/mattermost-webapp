                    ...
                    settings: [
                        {
                            ...
                            placeholder: 'admin.service.sessionDaysEx',
                            placeholder_default: 'E.g.: "30"',
                        },
                        {
                            type: Constants.SettingsTypes.TYPE_NUMBER,
                            key: 'ServiceSettings.SessionLengthMobileInDays',
                            label: 'admin.service.mobileSessionDays',
                            label_default: 'Session Length Mobile (days):',
                            help_text: 'admin.service.mobileSessionDaysDesc',
                            help_text_default: 'The number of days from the last time a user entered their credentials to the expiry of the users session. After changing this setting, the new session length will take effect after the next time the user enters their credentials.',
                            placeholder: 'admin.service.sessionDaysEx',
                            placeholder_default: 'E.g.: "30"',
                        },
                        {
                            ...
                            label: 'admin.service.ssoSessionDays',
                        ...
                        },
                        {
                            ...
                            label: 'admin.service.sessionCache',
                            label_default: 'Session Cache (minutes):',
                            help_text: 'admin.service.sessionCacheDesc',
                        ...
                        },
                        {
                            ...
                            label: 'admin.service.sessionIdleTimeout',
                            label_default: 'Session Idle Timeout (minutes):',
                            help_text: 'admin.service.sessionIdleTimeoutDesc',
                            ...
                            help_text_markdown: true,
                            placeholder: 'admin.service.sessionIdleTimeoutEx',
                            placeholder_default: 'E.g.: "60"',
            ...
            custom_integrations: {
                schema: {
                    ...
                    settings: [
                        ...
                        {
                            type: Constants.SettingsTypes.TYPE_BOOL,
                            key: 'ServiceSettings.EnableUserAccessTokensForAllUsers',
                            label: 'admin.service.userAccessTokensForAllUsersTitle',
                            label_default: 'Enable User Access Tokens for all users: ',
                            help_text: 'admin.service.userAccessTokensForAllUsersDescription',
                            help_text_default: 'When true, all users can create user access tokens without an admin giving them permission to do so.',
                            isDisabled: needsUtils.stateValueFalse('ServiceSettings.EnableUserAccessTokens'),
                        },
                    ],
                },
            },
