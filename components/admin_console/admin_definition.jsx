        ...
        posts: {
            ...
            schema: {
                ...
                settings: [
                    ...
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        key: 'ServiceSettings.UnoconvURL',
                        label: t('admin.service.unoconvURLTitle'),
                        label_default: 'Unoconv Server URL:',
                        placeholder: t('admin.service.unoconvURLExample'),
                        placeholder_default: 'E.g.: "http://localhost:4000"',
                        help_text: t('admin.service.unoconvURLDescription'),
                        help_text_default: 'Unoconv server allow us to preview office documents. To install and setup your own unoconv url server, you can go here https://github.com/alphakevin/unoconv-server and follow the instructions.',
