    ...
    render() {
        ...
        if (this.state.loadingReports) {
            ...
            for (var i = 0; i < this.props.reports.length; i++) {
                ...
                if (report.status === 'finished') {
                    status = <span style={{color: 'green'}}>{report.status}</span>;
                }
        ...
        if (this.props.serverError) {
            serverError = (
                <div className="form-group has-error" style={{marginTop: '10px'}}>
        ...
        return (
            <div className="panel compliance-panel">
                ...
                <div className="clearfix">
                    <button id="run-button" type="submit" className="btn btn-primary" onClick={this.runReport}>
