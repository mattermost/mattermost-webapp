...
export default class EmailSettings extends AdminSettings {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.notifications.email" defaultMessage="Email" />;
    }
    ...
    renderSettings() {
        ...
        if (this.props.config.ClusterSettings.Enable) {
            enableEmailBatchingDisabledText = (
                <span key="admin.email.enableEmailBatching.clusterEnabled" className="help-text">
            ...
            enableEmailBatchingDisabledText = (
                <span key="admin.email.enableEmailBatching.siteURL" className="help-text">
                    <FormattedHTMLMessage
        ...
        if (window.mm_license.EmailNotificationContents === 'true') {
            ...
            emailNotificationContentsTypes.push({
                value: EMAIL_NOTIFICATION_CONTENTS_FULL,
                text: Utils.localizeMessage('admin.email.notification.contents.full', 'Send full message contents')
            });
            emailNotificationContentsTypes.push({
                value: EMAIL_NOTIFICATION_CONTENTS_GENERIC,
                text: Utils.localizeMessage(
                    'admin.email.notification.contents.generic',
        ...
        return (
            <SettingsGroup>
                ...
                <BooleanSetting
                    ...
                    value={
                        this.state.enableEmailBatching &&
                        !this.props.config.ClusterSettings.Enable &&
                        Boolean(this.props.config.ServiceSettings.SiteURL)
                    }
                    onChange={this.handleChange}
                    disabled={
                        !this.state.sendEmailNotifications ||
                        this.props.config.ClusterSettings.Enable ||
                        !this.props.config.ServiceSettings.SiteURL
                    }
                />
                {emailNotificationContentsTypeDropdown}
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        'admin.email.notificationDisplayExample',
                ...
                <TextSetting
                    ...
                    placeholder={Utils.localizeMessage(
                        'admin.email.notificationEmailExample',
                ...
                <TextSetting
                    id="smtpServer"
                    label={<FormattedMessage id="admin.email.smtpServerTitle" defaultMessage="SMTP Server:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.email.smtpServerExample',
                ...
                <TextSetting
                    id="smtpPort"
                    label={<FormattedMessage id="admin.email.smtpPortTitle" defaultMessage="SMTP Server Port:" />}
                ...
                <TextSetting
                    id="smtpUsername"
                    label={
                        <FormattedMessage id="admin.email.smtpUsernameTitle" defaultMessage="SMTP Server Username:" />
                    }
                    placeholder={Utils.localizeMessage(
                        'admin.email.smtpUsernameExample',
                ...
                <TextSetting
                    id="smtpPassword"
                    label={
                        <FormattedMessage id="admin.email.smtpPasswordTitle" defaultMessage="SMTP Server Password:" />
                    }
                    placeholder={Utils.localizeMessage(
                        'admin.email.smtpPasswordExample',
                ...
                <BooleanSetting
                    ...
                    label={
                        <FormattedMessage id="admin.service.securityTitle" defaultMessage="Enable Security Alerts: " />
                    }
                    helpText={
                        <FormattedMessage
