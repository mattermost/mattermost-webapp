...
export default class GroupRow extends React.Component {
    ...
    renderActions = () => {
        ...
        if (this.props.has_syncables) {
            return (
                <Link to={'/admin_console/user_management/groups/' + this.props.mattermost_group_id} id={`${this.props.name}_edit`}>
                    <FormattedMessage
        ...
        return (
            <Link to={'/admin_console/user_management/groups/' + this.props.mattermost_group_id} id={`${this.props.name}_configure`}>
                <FormattedMessage
