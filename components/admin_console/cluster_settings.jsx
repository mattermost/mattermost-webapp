...
export default class ClusterSettings extends AdminSettings {
    ...
    renderSettings() {
        const licenseEnabled =
            global.window.mm_license.IsLicensed === 'true' && global.window.mm_license.Cluster === 'true';
        if (!licenseEnabled) {
            return null;
        }
        ...
        if (Client4.clusterId) {
            configLoadedFromCluster = (
                <div style={{marginBottom: '10px'}} className="alert alert-warning">
        ...
        return (
            <SettingsGroup>
                ...
                <BooleanSetting
                    id="ReadOnlyConfig"
                    label={<FormattedMessage id="admin.cluster.ReadOnlyConfig" defaultMessage="Read Only Config:" />}
                    helpText={
                        <FormattedHTMLMessage
