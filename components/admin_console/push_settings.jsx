...
export default class PushSettings extends AdminSettings {
    ...
    getStateFromConfig(config) {
        ...
        if (!config.EmailSettings.SendPushNotifications) {
            ...
            global.window.mm_license.MHPNS === 'true'
        ) {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.notifications.title" defaultMessage="Notification Settings" />;
    }
    ...
    renderSettings() {
        ...
        return (
            <SettingsGroup header={<FormattedMessage id="admin.notifications.push" defaultMessage="Mobile Push" />}>
                <DropdownSetting
                ...
                <TextSetting
                    ...
                    label={
                        <FormattedMessage id="admin.email.pushServerTitle" defaultMessage="Push Notification Server:" />
                    }
                    placeholder={Utils.localizeMessage(
                        'admin.email.pushServerEx',
                        'E.g.: "http://push-test.mattermost.com"'
                    )}
                    ...
                    values={[
                        {
                            ...
                            text: Utils.localizeMessage(
                                'admin.email.genericNoChannelPushNotification',
                        ...
                        },
                        {
                            value: 'generic',
                            text: Utils.localizeMessage(
                                'admin.email.genericPushNotification',
                                'Send generic description with sender and channel names'
                            )
                        },
                        {
                            value: 'full',
                            text: Utils.localizeMessage('admin.email.fullPushNotification', 'Send full message snippet')
                        }
                    ]}
                    label={
                        <FormattedMessage
