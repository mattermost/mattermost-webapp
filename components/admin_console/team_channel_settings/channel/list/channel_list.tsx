...
export default class ChannelList extends React.PureComponent<ChannelListProps, ChannelListState> {
    ...
    getPaginationProps = () => {
        ...
        const isSearching = term.length > 0 || JSON.stringify(filters) !== '{}';
    ...
    searchChannels = async (page = 0, term = '', filters = {}) => {
        ...
        const response = await this.props.actions.searchAllChannels(term, {page, per_page: PAGE_SIZE, ...filters, include_deleted: true});
        if (response?.data) {
