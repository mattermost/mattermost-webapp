...
const PlanDetails: React.FC<PlanDetailsProps> = ({typeSubscription}) => {
    ...
    return (
        <div className='PlanDetails'>
            {planDetailsTopElements(userCount, isPaidTier, typeSubscription, userLimit)}
            {planPricing}
            ...
            {featureList(typeSubscription, isPaidTier)}
