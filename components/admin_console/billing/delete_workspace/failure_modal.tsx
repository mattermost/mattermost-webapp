        ...
        >
            <div className='cloud_subscribe_result_modal'>
                <IconMessage
                    formattedTitle={
                        <FormattedMessage
                            defaultMessage={'We were unable to delete your workspace'}
                            id={'delete_workspace.error_modal.title'}
                            values={{
                    ...
                    formattedSubtitle={
                        <FormattedMessage
                            id={'delete_workspace.error_modal.subtitle'}
                            defaultMessage={
                                'An error occurred while deleting your workspace. Please go back and try again, or contact the support team.'
                            }
                        />
                    }
                    error={true}
