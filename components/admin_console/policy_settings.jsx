...
export default class PolicySettings extends AdminSettings {
    ...
    getConfigFromState(config) {
        ...
        config.ServiceSettings.PostEditTimeLimit = this.parseIntNonZero(
            this.state.postEditTimeLimit,
            Constants.DEFAULT_POST_EDIT_TIME_LIMIT
        );
    ...
    renderTitle() {
        return <FormattedMessage id="admin.general.policy" defaultMessage="Policy" />;
    }
        ...
        return (
            <SettingsGroup>
                <DropdownSetting
                    ...
                    values={[
                        {
                            value: Constants.PERMISSIONS_ALL,
                            text: Utils.localizeMessage('admin.general.policy.permissionsAll', 'All team members')
                        },
                        {
                            value: Constants.PERMISSIONS_TEAM_ADMIN,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsAdmin',
                                'Team and System Admins'
                            )
                        },
                        {
                            value: Constants.PERMISSIONS_SYSTEM_ADMIN,
                    ...
                    values={[
                        {
                            value: Constants.PERMISSIONS_ALL,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsAllChannel',
                                'All channel members'
                            )
                        },
                        {
                            value: Constants.PERMISSIONS_CHANNEL_ADMIN,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsChannelAdmin',
                                'Channel, Team and System Admins'
                            )
                        },
                        {
                            value: Constants.PERMISSIONS_TEAM_ADMIN,
                ...
                <RadioSetting
                    ...
                    values={[
                        {
                            value: Constants.PERMISSIONS_DELETE_POST_ALL,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsDeletePostAll',
                                'Message authors can delete their own messages, and Administrators can delete any message'
                            )
                        },
                        {
                            value: Constants.PERMISSIONS_DELETE_POST_TEAM_ADMIN,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsDeletePostAdmin',
                                'Team Admins and System Admins'
                            )
                        },
                        {
                            value: Constants.PERMISSIONS_DELETE_POST_SYSTEM_ADMIN,
                            text: Utils.localizeMessage(
                                'admin.general.policy.permissionsDeletePostSystemAdmin',
                                'System Admins'
                            )
                        }
                    ]}
                ...
                <TextSetting
                    id="bannerText"
                    label={<FormattedMessage id="admin.general.policy.bannerTextTitle" defaultMessage="Banner Text:" />}
                    helpText={
                        <FormattedMessage
                ...
                <ColorSetting
                    id="bannerColor"
                    label={
                        <FormattedMessage id="admin.general.policy.bannerColorTitle" defaultMessage="Banner Color:" />
                    }
