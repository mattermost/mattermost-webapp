...
export default class ExternalServiceSettings extends AdminSettings {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.integrations.external" defaultMessage="External Services" />;
    }
        ...
        return (
            <SettingsGroup>
                <TextSetting
                    ...
                    label={<FormattedMessage id="admin.service.googleTitle" defaultMessage="Google API Key:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.service.googleExample',
                        'Ex "7rAh6iwQCkV4cA1Gsg3fgGOXJAQ43QV"'
                    )}
                    helpText={
