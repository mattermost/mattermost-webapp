...
export default class OAuthSettings extends AdminSettings {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.authentication.oauth" defaultMessage="OAuth 2.0" />;
    }
    ...
    renderGoogle() {
        return (
            <div>
                <TextSetting
                    id="id"
                    label={<FormattedMessage id="admin.google.clientIdTitle" defaultMessage="Client ID:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.google.clientIdExample',
                        'Ex "7602141235235-url0fhs1mayfasbmop5qlfns8dh4.apps.googleusercontent.com"'
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="secret"
                    label={<FormattedMessage id="admin.google.clientSecretTitle" defaultMessage="Client Secret:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.google.clientSecretExample',
                ...
                <TextSetting
                    id="userApiEndpoint"
                    label={<FormattedMessage id="admin.google.userTitle" defaultMessage="User API Endpoint:" />}
                    value="https://www.googleapis.com/plus/v1/people/me"
                    disabled={true}
                />
                <TextSetting
                    id="authEndpoint"
                    label={<FormattedMessage id="admin.google.authTitle" defaultMessage="Auth Endpoint:" />}
                    value="https://accounts.google.com/o/oauth2/v2/auth"
                    disabled={true}
                />
                <TextSetting
                    id="tokenEndpoint"
                    label={<FormattedMessage id="admin.google.tokenTitle" defaultMessage="Token Endpoint:" />}
    ...
    renderOffice365() {
        return (
            <div>
                <TextSetting
                    id="id"
                    label={<FormattedMessage id="admin.office365.clientIdTitle" defaultMessage="Application ID:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.office365.clientIdExample',
                        'Ex "adf3sfa2-ag3f-sn4n-ids0-sh1hdax192qq"'
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="userApiEndpoint"
                    label={<FormattedMessage id="admin.office365.userTitle" defaultMessage="User API Endpoint:" />}
                    value="https://graph.microsoft.com/v1.0/me"
                    disabled={true}
                />
                <TextSetting
                    id="authEndpoint"
                    label={<FormattedMessage id="admin.office365.authTitle" defaultMessage="Auth Endpoint:" />}
                    value="https://login.microsoftonline.com/common/oauth2/v2.0/authorize"
                    disabled={true}
                />
                <TextSetting
                    id="tokenEndpoint"
                    label={<FormattedMessage id="admin.office365.tokenTitle" defaultMessage="Token Endpoint:" />}
    ...
    renderGitLab() {
        return (
            <div>
                <TextSetting
                    id="id"
                    label={<FormattedMessage id="admin.gitlab.clientIdTitle" defaultMessage="Application ID:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.gitlab.clientIdExample',
                ...
                <TextSetting
                    id="userApiEndpoint"
                    label={<FormattedMessage id="admin.gitlab.userTitle" defaultMessage="User API Endpoint:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.gitlab.userExample',
                        'Ex "https://<your-gitlab-url>/api/v4/user"'
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="authEndpoint"
                    label={<FormattedMessage id="admin.gitlab.authTitle" defaultMessage="Auth Endpoint:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.gitlab.authExample',
                        'Ex "https://<your-gitlab-url>/oauth/authorize"'
                    )}
                    helpText={
                        <FormattedMessage
                ...
                <TextSetting
                    id="tokenEndpoint"
                    label={<FormattedMessage id="admin.gitlab.tokenTitle" defaultMessage="Token Endpoint:" />}
                    placeholder={Utils.localizeMessage(
                        'admin.gitlab.tokenExample',
                        'Ex "https://<your-gitlab-url>/oauth/token"'
                    )}
                    helpText={
                        <FormattedMessage
    ...
    renderSettings() {
        ...
        oauthTypes.push({
            value: 'off',
            text: Utils.localizeMessage('admin.oauth.off', 'Do not allow sign-in via an OAuth 2.0 provider.')
        });
        ...
        if (global.window.mm_license.IsLicensed === 'true') {
            if (global.window.mm_license.GoogleOAuth === 'true') {
                oauthTypes.push({
                    ...
                    text: Utils.localizeMessage('admin.oauth.google', 'Google Apps')
                });
            }
            if (global.window.mm_license.Office365OAuth === 'true') {
                oauthTypes.push({
                    value: Constants.OFFICE365_SERVICE,
                    text: Utils.localizeMessage('admin.oauth.office365', 'Office 365 (Beta)')
                });
            }
        }
        ...
        return (
            <SettingsGroup>
                <DropdownSetting
                    ...
                    values={oauthTypes}
                    label={
                        <FormattedMessage id="admin.oauth.select" defaultMessage="Select OAuth 2.0 Service Provider:" />
                    }
                    helpText={helpText}
