    ...
    renderSettings() {
        ...
        if (global.window.mm_license.IsLicensed === 'true') {
            recycleDbButton = (
                <RequestButton
                    ...
                    buttonText={
                        <FormattedMessage id="admin.recycle.button" defaultMessage="Recycle Database Connections" />
                    }
        ...
        return (
            <SettingsGroup>
                ...
                <GeneratedSetting
                    id="atRestEncryptKey"
                    label={<FormattedMessage id="admin.sql.keyTitle" defaultMessage="At Rest Encrypt Key:" />}
                ...
                <BooleanSetting
                    id="trace"
                    label={<FormattedMessage id="admin.sql.traceTitle" defaultMessage="Trace: " />}
                    helpText={
                        <FormattedMessage
