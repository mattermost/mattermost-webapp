...
export default class GlobalPolicyForm extends AdminSettings<Props, State> {
    ...
    getStateFromConfig(config: Props['config']) {
        return {
            ...
            messageRetentionDropdownValue: !config.DataRetentionSettings.EnableMessageDeletion ? {value: 'forever', label: 'Keep Forever'} : config.DataRetentionSettings.MessageRetentionDays % 365 === 0 ? {value: 'years', label: 'Years'} : {value: 'days', label: 'Days'},
            ...
            fileRetentionDropdownValue: !config.DataRetentionSettings.EnableFileDeletion ? {value: 'forever', label: 'Keep Forever'} : config.DataRetentionSettings.FileRetentionDays % 365 === 0 ? {value: 'years', label: 'Years'} : {value: 'days', label: 'Days'},
