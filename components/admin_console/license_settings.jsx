            ...
            licenseKey = (
                <div className='col-sm-8'>
                    <button
                        ...
                        id='remove-button'
                        data-loading-text={'<span class=\'fa fa-refresh icon--rotate\' title=\'Reload icon\'></span> ' + this.props.intl.formatMessage(holders.removing)}
                    >
                        <FormattedMessage
            ...
            licenseKey = (
                <div className='col-sm-8'>
                    ...
                    <button
                        ...
                        id='upload-button'
                        data-loading-text={'<span class=\'fa fa-refresh icon--rotate\' title=\'Reload icon\'></span> ' + this.props.intl.formatMessage(holders.uploading)}
                    >
                        <FormattedMessage
