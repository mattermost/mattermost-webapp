...
class LicenseSettings extends React.Component {
    ...
    render() {
        ...
        const issued =
            Utils.displayDate(parseInt(global.window.mm_license.IssuedAt, 10)) +
            ' ' +
            Utils.displayTime(parseInt(global.window.mm_license.IssuedAt, 10), true);
        ...
        if (global.window.mm_license.IsLicensed === 'true') {
            ...
            licenseType = (
                <div>
                    ...
                    <br />
                    {'See also '}
                    <a href="https://about.mattermost.com/enterprise-edition-terms/">
                        {'Enterprise Edition Terms of Service'}
                    </a>
                    {' and '}
                    <a href="https://about.mattermost.com/privacy/">{'Privacy Policy.'}</a>
                </div>
            );
            ...
            licenseKey = (
                <div className="col-sm-8">
                    <button
                        ...
                        id="remove-button"
                        data-loading-text={
                            "<span class='fa fa-refresh icon--rotate'></span> " +
                            this.props.intl.formatMessage(holders.removing)
                        }
                    >
                        <FormattedMessage
            ...
            edition = (
                <p>
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://mattermost.com/">
            ...
            licenseKey = (
                <div className="col-sm-8">
                    <div className="file__upload">
                        ...
                        <input ref="fileInput" type="file" accept=".mattermost-license" onChange={this.handleChange} />
                    </div>
                    <button
                        className={btnClass}
                        ...
                        data-loading-text={
                            "<span class='fa fa-refresh icon--rotate'></span> " +
                            this.props.intl.formatMessage(holders.uploading)
                        }
                    >
                        <FormattedMessage id="admin.license.upload" defaultMessage="Upload" />
                    </button>
        ...
        return (
            <div className="wrapper--fixed">
                <h3 className="admin-console-header">
                    <FormattedMessage id="admin.license.title" defaultMessage="Edition and License" />
                </h3>
