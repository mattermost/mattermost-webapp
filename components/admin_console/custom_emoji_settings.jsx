...
export default class CustomEmojiSettings extends AdminSettings {
    ...
    renderTitle() {
        return <FormattedMessage id="admin.customization.emoji" defaultMessage="Emoji" />;
    }
                    ...
                    values={[
                        {
                            ...
                            text: Utils.localizeMessage(
                                'admin.customization.restrictCustomEmojiCreationAll',
                                'Allow everyone to create custom emoji'
                            )
                        },
                        {
                            value: 'admin',
                            text: Utils.localizeMessage(
                                ...
                                'Allow System and Team Admins to create custom emoji'
                            )
                        },
                        {
                            value: 'system_admin',
                            text: Utils.localizeMessage(
                                'admin.customization.restrictCustomEmojiCreationSystemAdmin',
                                'Only allow System Admins to create custom emoji'
                            )
                        }
                    ]}
                    label={
