...
import {get, getBool, makeGetCategory} from 'mattermost-redux/selectors/entities/preferences';
...
function makeMapStateToProps() {
    ...
    return (state) => {
        ...
        return {
            ...
            codeBlockOnCtrlEnter: getBool(state, Preferences.CATEGORY_ADVANCED_SETTINGS, 'code_block_ctrl_enter'),
