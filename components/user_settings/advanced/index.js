...
import {get as getPreference, makeGetCategory} from 'mattermost-redux/selectors/entities/preferences';
...
function makeMapStateToProps() {
    ...
    return (state) => {
        ...
        return {
            ...
            sendOnCtrlEnter: getPreference(state, Preferences.CATEGORY_ADVANCED_SETTINGS, 'send_on_ctrl_enter', 'false'),
            formatting: getPreference(state, Preferences.CATEGORY_ADVANCED_SETTINGS, 'formatting', 'true'),
            joinLeave: getPreference(state, Preferences.CATEGORY_ADVANCED_SETTINGS, 'join_leave', 'true'),
