...
function mapStateToProps(state: GlobalState) {
    ...
    return {
        ...
        globalHeaderDisplay: !isMobile && get(state, Preferences.CATEGORY_DISPLAY_SETTINGS, Preferences.GLOBAL_HEADER_DISPLAY, Preferences.GLOBAL_HEADER_DISPLAY_OFF),
        ...
        globalHeaderAllowed: !isMobile && getFeatureFlagValue(state, 'GlobalHeader') === 'true',
    };
}
