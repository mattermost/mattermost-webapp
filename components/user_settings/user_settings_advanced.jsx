...
export default class AdvancedSettingsDisplay extends React.Component {
    ...
    getStateFromStores() {
        ...
        const settings = {
            ...
            formatting: PreferenceStore.get(Constants.Preferences.CATEGORY_ADVANCED_SETTINGS, 'formatting', 'true'),
            join_leave: PreferenceStore.get(Constants.Preferences.CATEGORY_ADVANCED_SETTINGS, 'join_leave', 'true')
        };
    ...
    renderJoinLeaveSection() {
        if (
            window.mm_config.BuildEnterpriseReady === 'true' &&
            window.mm_license &&
            window.mm_license.IsLicensed === 'true'
        ) {
                            ...
                            <div className="checkbox">
                                <label>
                                    <input
                                        ...
                                        type="checkbox"
                                        checked={
                                            this.state.settings[Constants.FeatureTogglePrefix + feature.label] ===
                                            'true'
                                        }
                                        onChange={e => {
