    ...
    render() {
        ...
        if (emoji) {
            ...
            if (emoji.aliases && emoji.category && emoji.batch) {
                ...
                name = emoji.name;
                aliases = [emoji.name];
                previewImage = <img className="emoji-picker__preview-image" src={EmojiStore.getEmojiImageUrl(emoji)} />;
            }
            ...
            return (
                <div className="emoji-picker__preview">
                    ...
                    <div className="emoji-picker__preview-image-label-box">
                        ...
                        <span className="emoji-picker__preview-aliases">{':' + aliases[0] + ':'}</span>
                    </div>
                </div>
            );
        }
