...
export default class Root extends React.Component {
    constructor(props) {
        ...
        $(window).bind('storage', e => {
            ...
            if (
                e.originalEvent.key === '__logout__' &&
    ...
    render() {
        ...
        return (
            <IntlProvider locale={this.state.locale} messages={this.state.translations} key={this.state.locale}>
                {this.props.children}
            </IntlProvider>
        );
    }
