    ...
    renderTitle = () => {
        switch (this.props.location.query.type) {
            case ErrorPageTypes.LOCAL_STORAGE:
                return <FormattedMessage id="error.local_storage.title" defaultMessage="Cannot Load Mattermost" />;
            case ErrorPageTypes.PERMALINK_NOT_FOUND:
                return <FormattedMessage id="permalink.error.title" defaultMessage="Message Not Found" />;
            case ErrorPageTypes.PAGE_NOT_FOUND:
                return <FormattedMessage id="error.not_found.title" defaultMessage="Message Not Found" />;
        }
                    ...
                    <div>
                        ...
                        <p>
                            <FormattedMessage
                                ...
                                values={{
                                    link: this.renderLink(
                                        'https://forum.mattermost.org/c/trouble-shoot',
