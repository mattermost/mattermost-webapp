...
class SelfHostedPurchaseModal extends React.PureComponent<Props, State> {
    ...
    async componentDidMount() {
        if (isEmpty(this.state.currentProduct || this.state.selectedProduct)) {
            await this.props.actions.getSelfHostedProducts();
                            ...
                            {this.state.processing ? (
                                <div>
                                    <ProcessPaymentSetup
                                        ...
                                        onClose={() => {
                                            this.props.actions.getSelfHostedProducts();
...
export default injectIntl(SelfHostedPurchaseModal);
