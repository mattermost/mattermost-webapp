...
import {getCloudSubscription, getInvoices} from 'mattermost-redux/actions/cloud';
import {getSelfHostedProducts} from 'mattermost-redux/actions/self_hosted';
...
const SelfHostedModal = makeAsyncComponent('SelfHostedPurchaseModal', React.lazy(() => import('./self_hosted_purchase_modal')));
...
function mapDispatchToProps(dispatch: Dispatch) {
    return {
        actions: bindActionCreators<ActionCreatorsMapObject<Action>, Actions>(
            {
                closeModal: () => closeModal(ModalIdentifiers.SELF_HOSTED_PURCHASE),
                openModal,
...
export default connect(mapStateToProps, mapDispatchToProps)(SelfHostedModal)