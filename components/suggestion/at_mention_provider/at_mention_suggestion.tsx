...
class AtMentionSuggestion extends Suggestion<Props> {
    render() {
                    ...
                    <Tag
                        text={
                            <FormattedMessage
                                ...
                                values={{
                                    member_count: (item as unknown as Group).member_count,
                                }}
                            />
                        }
                    />
...
export default injectIntl<'intl', WrappedComponentProps<'intl'> & SuggestionProps>(AtMentionSuggestion);
