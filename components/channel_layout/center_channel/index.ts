...
import {isCollapsedThreadsEnabled, getUseCaseOnboarding, isInsightsEnabled} from 'mattermost-redux/selectors/entities/preferences';
...
const mapStateToProps = (state: GlobalState, ownProps: Props) => {
    ...
    return {
        ...
        isInsightsEnabled: isInsightsEnabled(state),
    };
};
