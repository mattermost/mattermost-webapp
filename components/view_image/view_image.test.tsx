...
describe('components/ViewImageModal', () => {
    ...
    test('should match snapshot, modal not shown', () => {
        ...
        const wrapper: ShallowWrapper<any, any, ViewImageModal> = shallow(<ViewImageModal {...props}/>);
    ...
    test('should match snapshot, loading', () => {
        const wrapper: ShallowWrapper<any, any, ViewImageModal> = shallow(<ViewImageModal {...baseProps}/>);
