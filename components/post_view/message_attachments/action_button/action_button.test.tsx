...
describe('components/post_view/message_attachments/action_button.jsx', () => {
    const baseProps = {
        ...
        theme: Constants.THEMES.sapphire as unknown as Theme,
    };
    ...
    test('should have correct styles when provided color from theme', () => {
        ...
        expect(buttonStyles).toHaveProperty('borderColor', changeOpacity(Constants.THEMES.sapphire.onlineIndicator, 0.25));
        expect(buttonStyles).toHaveProperty('borderWidth', 2);
        expect(buttonStyles).toHaveProperty('color', Constants.THEMES.sapphire.onlineIndicator);
    });

    test('should have correct styles when provided color from not default theme', () => {
        const props = {
            ...baseProps,
            theme: Constants.THEMES.indigo as unknown as Theme,
        ...
        expect(buttonStyles).toHaveProperty('borderColor', changeOpacity(Constants.THEMES.indigo.errorTextColor, 0.25));
        expect(buttonStyles).toHaveProperty('borderWidth', 2);
        expect(buttonStyles).toHaveProperty('color', Constants.THEMES.indigo.errorTextColor);
    });
