...
const messages = defineMessages({
    readonlyDefault: {
        ...
        defaultMessage: '<strong>Welcome to {display_name}!</strong> {br}{br} Messages can only be posted by system admins. Everyone automatically becomes a permanent member of this channel when they join the team.',
    },
    default: {
        id: t('intro_messages.default'),
        defaultMessage: '<strong>Welcome to {display_name}!</strong> {br}{br} Post messages here that you want everyone to see. Everyone automatically becomes a permanent member of this channel when they join the team.',
    },
    addGroupsToTeam: {
