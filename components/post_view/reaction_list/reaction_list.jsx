...
import {getReactionsMap} from 'utils/post_utils';
...
export default class ReactionList extends React.PureComponent {
    ...
    render() {
        const {reactionsByName, emojiNames} = getReactionsMap(this.props.reactions);
        ...
        if (this.props.enableEmojiPicker && emojiNames.length < Constants.POST_REACTIONS_LIMIT) {
