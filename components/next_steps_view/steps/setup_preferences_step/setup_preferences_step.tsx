    ...
    return (
        <>
            <TextCardWithAction
                ...
                cardBodyDefaultMessage={'You can update your profile and manage security settings by selecting your Avatar. Select Settings to change how you receive notifications, customize your display settings, and more.'}
