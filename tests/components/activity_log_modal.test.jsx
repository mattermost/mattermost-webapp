...
describe('components/ActivityLogModal', () => {
    ...
    test('should match when mobileSessionInfo is called', () => {
        ...
        const apple = {devicePicture: 'fa fa-apple', deviceTitle: 'Apple icon', devicePlatform: <FormattedMessage defaultMessage='iPhone Native Classic App' id='activity_log_modal.iphoneNativeClassicApp' values={{}}/>}; //eslint-disable-line react/jsx-max-props-per-line
        expect(mobileSessionInfo({device_id: 'apple'})).toEqual(apple);

        const android = {devicePicture: 'fa fa-android', deviceTitle: 'Android icon', devicePlatform: <FormattedMessage defaultMessage='Android Native Classic App' id='activity_log_modal.androidNativeClassicApp' values={{}}/>}; //eslint-disable-line react/jsx-max-props-per-line
        expect(mobileSessionInfo({device_id: 'android'})).toEqual(android);

        const appleRN = {devicePicture: 'fa fa-apple', deviceTitle: 'Apple icon', devicePlatform: <FormattedMessage defaultMessage='iPhone Native App' id='activity_log_modal.iphoneNativeApp' values={{}}/>}; //eslint-disable-line react/jsx-max-props-per-line
        expect(mobileSessionInfo({device_id: 'apple_rn'})).toEqual(appleRN);

        const androidRN = {devicePicture: 'fa fa-android', deviceTitle: 'Android icon', devicePlatform: <FormattedMessage defaultMessage='Android Native App' id='activity_log_modal.androidNativeApp' values={{}}/>}; //eslint-disable-line react/jsx-max-props-per-line
