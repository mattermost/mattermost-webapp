...
describe('Channel sidebar', () => {
    ...
    it('should move channel to correct place when dragging channel within category', () => {
        ...
        cy.get('.SidebarChannel > .SidebarLink').
            should('be.visible').eq(0).
            should('contain', 'Off-Topic');
        cy.get('.SidebarChannel > .SidebarLink').
    ...
    it('should move category to correct place', () => {
        ...
        cy.get('.SidebarChannelGroupHeader_groupButton > div[data-rbd-drag-handle-draggable-id]').
            should('contain', 'PUBLIC CHANNELS').
            should('be.visible');
        cy.get('.SidebarChannelGroupHeader_groupButton > div[data-rbd-drag-handle-draggable-id]').
            should('be.visible').eq(0).
            should('contain', 'PUBLIC CHANNELS');
