...
var username = "Howard"+timestamp.toString();
...
describe ('Test Tutorial Navigation', () => {
	...
	it('MM-13989 : After login, the first page of the tutorial should display.', () => {
	...
	it('Clicking the icon should display the Mattermost download page.', function(){
		      ...
		      cy.get('#appDownloadImage').then(function($a){
