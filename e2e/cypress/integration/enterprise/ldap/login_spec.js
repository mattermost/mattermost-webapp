...
import ldapSettings from '../../../fixtures/openldapdocker.json';
...
describe('Login page', () => {
    before(() => {
        ...
        // };
        cy.apiUpdateConfig(ldapSettings);
    ...
    it('should login then logout by user-1', () => {
        ...
        cy.get('#loginId').should('be.visible').type('test.one');

        // # Enter "user-1" on "Password" input box
        cy.get('#loginPassword').should('be.visible').type('Password1');
