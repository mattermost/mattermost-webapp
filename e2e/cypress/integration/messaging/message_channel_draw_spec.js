...
describe('Draw plugin : Post message', () => {
    ...
    it('M11759-Draw plugin : Upload Image and check Message doesnt post', () => {
    ...
    // Step 3 : Validate draft message doesn't post to channel
    it('M11759-Draw plugin : Cancel draw plugin upload and check Message doesnt post', () => {
        cy.get('i.icon.fa.fa-paint-brush').click();
    ...
    it('M11759-Draw plugin : click on Your Computer', () => {
