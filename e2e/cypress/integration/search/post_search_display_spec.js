...
describe('Post search display', () => {
    ...
    it('MM-T350 - Searching displays results in RHS', () => {
        ...
        cy.get('#searchBox').type('hello').type('{enter}').should('have.value', 'hello');
    ...
    it('MM-T376 - From:user search, using autocomplete', () => {
        ...
        cy.apiCreateUser().then(({user}) => {
            ...
            cy.get('#searchBox').type(testSearch, {force: true});
...
const enableTestCommands = (team) => {
    ...
    // # Save changes
    cy.get('[data-testid="saveSetting"]').click().wait(TIMEOUTS.HALF_SEC);
