...
describe('Customization', () => {
    ...
    it('MM-T1205 - Can change Site Description setting', () => {
        ...
        cy.findByTestId('TeamSettings.CustomDescriptionTexthelp-text').find('span').should('be.visible').and('have.text', 'Description of service shown in login screens and UI. When not specified, "Collaborate with your team in real-time" is displayed.');
