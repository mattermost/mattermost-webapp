...
import {SystemSetting} from '../../../../packages/mattermost-redux/src/types/general';

import {General} from '../../../../packages/mattermost-redux/src/constants';

import {ClusterInfo, AnalyticsRow} from '../../../../packages/mattermost-redux/src/types/admin';
import type {
    AppBinding,
    AppCallRequest,
    AppCallResponse,
    AppCallType,
} from '../../../../packages/mattermost-redux/src/types/apps';
import {Audit} from '../../../../packages/mattermost-redux/src/types/audits';
import {UserAutocomplete, AutocompleteSuggestion} from '../../../../packages/mattermost-redux/src/types/autocomplete';
import {Bot, BotPatch} from '../../../../packages/mattermost-redux/src/types/bots';
import {
    Product,
    Subscription,
    CloudCustomer,
    ...
    Invoice,
    SubscriptionStats,
} from '../../../../packages/mattermost-redux/src/types/cloud';
import {
    ChannelCategory,
    OrderedChannelCategories,
} from '../../../../packages/mattermost-redux/src/types/channel_categories';
import {
    Channel,
    ...
    ChannelSearchOpts,
    ServerChannel,
} from '../../../../packages/mattermost-redux/src/types/channels';
import {Options, StatusOK, ClientResponse} from '../../../../packages/mattermost-redux/src/types/client4';
import {Compliance} from '../../../../packages/mattermost-redux/src/types/compliance';
import {
    ClientConfig,
    ClientLicense,
    DataRetentionPolicy,
...
import {ServerError} from '../../../../packages/mattermost-redux/src/types/errors';

import {FileInfo, FileUploadResponse, FileSearchResults} from '../../../../packages/mattermost-redux/src/types/files';
...
import {
    ...
    GroupSearachParams,
    CustomGroupPatch,
} from '../../../../packages/mattermost-redux/src/types/groups';
import {PostActionResponse} from '../../../../packages/mattermost-redux/src/types/integration_actions';
import {
    Command,
    CommandArgs,
    CommandResponse,
...
} from '../../../../packages/mattermost-redux/src/types/integrations';
import {Job} from '../../../../packages/mattermost-redux/src/types/jobs';
import {MfaSecret} from '../../../../packages/mattermost-redux/src/types/mfa';
import {
    ClientPluginManifest,
    PluginManifest,
    PluginsResponse,
    PluginStatus,
} from '../../../../packages/mattermost-redux/src/types/plugins';
import type {MarketplaceApp, MarketplacePlugin} from '../../../../packages/mattermost-redux/src/types/marketplace';
import {
    Post,
    PostList,
    PostSearchResults,
    OpenGraphMetadata,
} from '../../../../packages/mattermost-redux/src/types/posts';
import {PreferenceType} from '../../../../packages/mattermost-redux/src/types/preferences';
import {Reaction} from '../../../../packages/mattermost-redux/src/types/reactions';
import {Role} from '../../../../packages/mattermost-redux/src/types/roles';
import {SamlCertificateStatus, SamlMetadataResponse} from '../../../../packages/mattermost-redux/src/types/saml';
import {Scheme} from '../../../../packages/mattermost-redux/src/types/schemes';
import {Session} from '../../../../packages/mattermost-redux/src/types/sessions';
import {
    GetTeamMembersOpts,
    Team,
    TeamInviteWithError,
    ...
    TeamUnread,
    TeamSearchOpts,
} from '../../../../packages/mattermost-redux/src/types/teams';
import {TermsOfService} from '../../../../packages/mattermost-redux/src/types/terms_of_service';
import {
    AuthChangeResponse,
    UserAccessToken,
    UserProfile,
    ...
    UserCustomStatus,
} from '../../../../packages/mattermost-redux/src/types/users';
import {RelationOneToOne} from '../../../../packages/mattermost-redux/src/types/utilities';
import {ProductNotices} from '../../../../packages/mattermost-redux/src/types/product_notices';
import {
    DataRetentionCustomPolicies,
    CreateDataRetentionCustomPolicy,
    PatchDataRetentionCustomPolicy,
    GetDataRetentionCustomPoliciesRequest,
} from '../../../../packages/mattermost-redux/src/types/data_retention';
import {CompleteOnboardingRequest} from '../../../../packages/mattermost-redux/src/types/setup';

import {buildQueryString, isMinimumServerVersion} from './helpers';
import {cleanUrlForLogging} from '../../../../packages/mattermost-redux/src/utils/sentry';
import {isSystemAdmin} from '../../../../packages/mattermost-redux/src/utils/user_utils';
...
export default class Client4 {
    ...
    setTeamIcon = (teamId: string, filePath: string) => {
    ...
    getPostsByIds = (postIds: string[]) => {
        return this.doFetch<Post[]>(`${this.getPostsRoute()}/ids`, {method: 'post', body: JSON.stringify(postIds)});
    };
    ...
    createCustomEmoji = (emoji: CustomEmoji, filePath: string) => {
    ...
    uploadBrandImage = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
        formData.append('image', fileData, path.basename(filePath));
    ...
    uploadPublicSamlCertificate = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
    ...
    uploadPrivateSamlCertificate = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
        formData.append('certificate', fileData, path.basename(filePath));
    ...
    uploadPublicLdapCertificate = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
        formData.append('certificate', fileData, path.basename(filePath));
    ...
    uploadPrivateLdapCertificate = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
        formData.append('certificate', fileData, path.basename(filePath));
    ...
    uploadIdpSamlCertificate = (filePath: string) => {
        const fileData = fs.readFileSync(filePath);
        const formData = new FormData();
        formData.append('certificate', fileData, path.basename(filePath));
    ...
    getPrevTrialLicense = () => {
        return this.doFetch<ClientLicense>(`${this.getBaseRoute()}/trial-license/prev`, {method: 'get'});
    };
    ...
    uploadPlugin = async (filePath: string, force = false) => {
    ...
    createGroupWithUserIds = (group: GroupCreateWithUserIds) => {
        return this.doFetch<Group>(this.getGroupsRoute(), {method: 'post', body: JSON.stringify(group)});
    };
