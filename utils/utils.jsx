...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.app__body .custom-textarea::-moz-placeholder, .app__body .custom-textarea:-moz-placeholder, .app__body .post.post--system .post__body, .app__body .modal .channel-switch-modal .modal-header .close', 'color:' + changeOpacity(theme.centerChannelColor, 0.6));
