...
export function applyTheme(theme) {
    ...
    if (theme.sidebarText) {
        ...
        changeCss('@media(max-width: 768px){.app__body .search__icon svg', 'fill:' + theme.sidebarText);
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('@media(min-width: 768px){.app__body .search__icon svg', 'fill:' + changeOpacity(theme.centerChannelColor, 0.4));
        ...
        changeCss('.app__body .date-separator .separator__hr, .app__body .modal-footer, .app__body .modal .custom-textarea', 'border-color:' + changeOpacity(theme.centerChannelColor, 0.08));
        ...
        changeCss('.app__body .post.current--user .post__body, .app__body .post.post--comment.other--root.current--user .post-comment, .app__body pre, .app__body .post-right__container .post.post--root', 'background:' + changeOpacity(theme.centerChannelColor, 0.03));
        ...
        changeCss('.app__body .more-modal__list .more-modal__row', 'border-color:' + changeOpacity(theme.centerChannelColor, 0));
        ...
        changeCss('@media(min-width: 768px){.app__body .post:hover, .app__body .more-modal__list .more-modal__row:hover, .app__body .modal .settings-modal .settings-table .settings-content .section-min:hover', 'background:' + changeOpacity(theme.centerChannelColor, 0.03));
    ...
    if (theme.linkColor) {
        ...
        changeCss('@media(min-width: 768px){.app__body .search__form.focused .search__icon svg', 'fill:' + theme.linkColor);
