...
export function applyTheme(theme) {
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('@media(min-width: 768px){.app__body .post:hover, .app__body .modal .settings-modal .settings-table .settings-content .section-min:hover', 'background:' + changeOpacity(theme.centerChannelColor, 0.08));
