...
export function applyTheme(theme) {
    ...
    if (theme.sidebarHeaderTextColor) {
        ...
        changeCss(
            '.app__body #navbar_wrapper .navbar-default .navbar-brand',
            'color:' + theme.sidebarHeaderTextColor
        );
        changeCss(
    ...
    if (theme.centerChannelBg) {
        ...
        changeCss(
            ...
            `background:linear-gradient(${changeOpacity(theme.centerChannelBg, 0)}, ${
    ...
    if (theme.linkColor) {
        ...
        changeCss(
            '.app__body .member-list__popover .more-modal__actions svg',
            'fill:' + theme.linkColor
        );
        changeCss(
...
export function handleFormattedTextClick(e, currentRelativeTeamUrl) {
    ...
    if (hashtagAttribute) {
        ...
        if (
            !(e.button === MIDDLE_MOUSE_BUTTON || e.altKey || e.ctrlKey || e.metaKey || e.shiftKey)
        ) {
            e.preventDefault();
...
export function applyHotkeyMarkdown(e) {
    ...
    const hasItalicAndBold =
        prefix.endsWith(BOLD_MD + ITALIC_MD) && suffix.startsWith(BOLD_MD + ITALIC_MD);
