...
import {PostTypes, RHSStates, ValueOf} from 'utils/constants';
import {localizeMessage} from 'utils/utils.jsx';
import {GlobalState} from 'types/store';
import {FakePost, PostDraft} from 'types/store/rhs';
...
export function getRhsState(state: GlobalState): ValueOf<typeof RHSStates> {
    return state.views.rhs.rhsState;
}

export function getPreviousRhsState(state: GlobalState): ValueOf<typeof RHSStates> {
